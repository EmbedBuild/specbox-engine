...
| UC | Título | Estado |
|----|--------|--------|
| UC-701 | [Auto-detección de skills desde filesystem](../uc/UC-084-auto-deteccion-de-skills-desde-filesystem.md) | review |
| UC-702 | [Agrupación de skills por categoría](../uc/UC-085-agrupacion-de-skills-por-categoria.md) | review |
| UC-703 | [Ficha de skill al hacer click](../uc/UC-086-ficha-de-skill-al-hacer-click.md) | review |
| UC-704 | [Walkthrough actualizado + tooltip rico](../uc/UC-087-walkthrough-actualizado-tooltip-rico.md) | review |
| UC-705 | [Tests + smoke manual + bump versión](../uc/UC-088-tests-smoke-manual-bump-version.md) | review |
