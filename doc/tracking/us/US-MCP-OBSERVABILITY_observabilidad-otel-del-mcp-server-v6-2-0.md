...
> 
> **Scope v1**: instrumentacion pura — cero cambios en el comportamiento de las tools. Cubre los 3 verbos: spans (perf + errores), 3 metricas (calls_total counter, errors_total counter, duration_ms histogram), logs estructurados correlacionados por trace_id.
> 
