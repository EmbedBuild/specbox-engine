...
> SpecBox Engine v5.19.0 — Orquestacion multi-agente nativa de Claude Code (experimental)
...
Todos los prompts de teammates incluyen una seccion de integracion con el engine v3.5. Esto les da conocimiento de:
