...
| UC | Título | Estado |
|----|--------|--------|
| UC-401 | [Conexion asyncpg al Supabase Pooler (transaction-mode)](../uc/UC-013-conexion-asyncpg-al-supabase-pooler-transaction-mode.md) | done |
| UC-402 | [Schema sobre las migraciones nativas de Supabase (CLI/apply_migration)](../uc/UC-014-schema-sobre-las-migraciones-nativas-de-supabase-cli-apply-m.md) | done |
| UC-403 | [RLS y policies sobre las tablas public (silenciar advisors)](../uc/UC-015-rls-y-policies-sobre-las-tablas-public-silenciar-advisors.md) | done |
| UC-404 | [Gestion y rotacion de la credencial Supabase (Frontera 2)](../uc/UC-011-gestion-y-rotacion-de-la-credencial-supabase-frontera-2.md) | done |
| UC-405 | [Dev local y suite de conformidad contra Supabase](../uc/UC-012-dev-local-y-suite-de-conformidad-contra-supabase.md) | done |
