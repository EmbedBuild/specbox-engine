...
| UC | Título | Estado |
|----|--------|--------|
| UC-001 | [Configuración MCP solo-Remote](../uc/UC-001_configuracion-mcp-solo-remote.md) | done |
| UC-002 | [Engram vía brew, sin Python](../uc/UC-002_engram-via-brew-sin-python.md) | done |
| UC-003 | [Health check sin Python](../uc/UC-003_health-check-sin-python.md) | done |
| UC-004 | [Documentación cero-Python](../uc/UC-004_documentacion-cero-python.md) | done |
| UC-005 | [Verificación global cero-Python](../uc/UC-005_verificacion-global-cero-python.md) | done |
