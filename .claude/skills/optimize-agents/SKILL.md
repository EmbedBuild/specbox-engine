...
description: >
  Audit, score, and optimize the multi-agent system. Analyzes documentation
  sync, validation strategy, model optimization, team coordination, and
  Agent Teams readiness. Use when the user says "audit agents", "optimize system",
  "agent score", "check agent health", or references improving the agentic setup.
context: fork
agent: Explore
