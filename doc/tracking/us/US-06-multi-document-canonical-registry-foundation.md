...
| UC | Título | Estado |
|----|--------|--------|
| UC-D005 | [Refactor app_docs a registro multi-doc](../uc/UC-041-refactor-app-docs-a-registro-multi-doc.md) | ready |
| UC-D006 | [Introducción de app_market.md vía el registro](../uc/UC-045-introduccion-de-app-market-md-via-el-registro.md) | ready |
